                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Input
                                        ...
                                        onChange={e => {
                                            if (
                                                parseInt(e.target.value, 16) > 0xff ||
            ...
            setTimeout(function () {
                ...
                for (const attr in newParts) {
                    ...
                    newParts[attr].sort((a, b) => {
                        ...
                        if (parseInt(aDB[1], 10) > parseInt(bDB[1], 10)) {
                            return 1;
                        }
                        if (parseInt(aDB[1], 10) < parseInt(bDB[1], 10)) {
                            return -1;
                        ...
                        if (parseInt(aOffset[1], 10) > parseInt(bOffset[1], 10)) {
                            return 1;
                        }
                        if (parseInt(aOffset[1], 10) < parseInt(bOffset[1], 10)) {
                            return -1;
                        }
                        if (aOffset[2] === undefined && bOffset[2] !== undefined) {
                            return 1;
                        }
                        if (bOffset[2] === undefined && aOffset[2] !== undefined) {
                            return -1;
                        }
                        if (aOffset[2] === undefined && bOffset[2] === undefined) {
                            return 0;
                        }
                        if (parseInt(aOffset[2], 10) > parseInt(bOffset[2], 10)) {
                            return 1;
                        }
                        if (parseInt(aOffset[2], 10) < parseInt(bOffset[1], 10)) {
                            return -1;
                        }
                        return 0;
                    });
